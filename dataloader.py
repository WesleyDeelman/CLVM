...
class DataLoader:
    ...
    def rfm_segments(self,date: str, window: pd.Timedelta, df: pd.DataFrame) -> pd.DataFrame:
        ...
        data['date'] = date
        return data[['customer_id', 'date', 'rfm_score','rfm_score_int', 'segment']]
    ...
    def dedup_demographic_variables(self,df: pd.DataFrame) -> pd.DataFrame:
        ...
        deduplicated_demographics = data[demographic_cols].drop_duplicates(subset=['customer_id'], keep='last')
